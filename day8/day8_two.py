...
def count_largest_circuits(junction_box_strings):
    ...
    # Continuously connect the closest junction boxes.
    i = 0
    while True:
        ...
        if len(all_old_jb_ids) == 1000:
            # Print out boxes from which we can see x values for manual multiplication.
            print(f"Boxes performing final connection: box1: {box1} box2: {box2}")
            break
        # print(f"All old jb ids: {all_old_jb_ids}")
        ...
        for old_jb_id in all_old_jb_ids:
            ...
            # print(f"Setting old junction box {old_jb_id} to new circuit {new_circuit_id}")
        ...
        # Delete them.
        # print(f"Deleting old circuit ids: {box1_circuit_id} {box2_circuit_id}")
        del circuit_jb_lookup[box1_circuit_id]
        del circuit_jb_lookup[box2_circuit_id]
        # Add the new circuits.
        # 5. Add the new circuit to the circuit_id:jb_ids map.
        # print(f"Adding new circuit: {new_circuit_id}")
...
def main():
    ...
    count_largest_circuits(junction_lines)
